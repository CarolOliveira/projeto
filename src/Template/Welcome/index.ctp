        ...
        <div class="container">
            <div class="carousel-inner">
                <div class="item active">
                           <!-- <div class="row"> -->
                    <div class="col-md-6">
                        <span class="title">Teste Slide 1</span>
                        <p>
                    ...
                    <div class="col-md-6" id="micro-home">
                ...
                <div class="item">
                    <div class="col-md-6">
                        <span class="title">Teste Slide 2</span>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, 
                            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris 
                ...
                <div class="item">
                    <div class="col-md-6">
                        <span class="title">Teste Slide 3</span>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, 
                            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
                            Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris 
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-justify">Prezado Empresário,
